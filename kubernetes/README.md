...
curl -fsSL https://raw.githubusercontent.com/yoobinshin/agents/main/kubernetes/claude.md \
...
mkdir -p ~/.codex
curl -fsSL https://raw.githubusercontent.com/yoobinshin/agents/main/kubernetes/codex.md \
  -o ~/.codex/AGENTS.md
...
```bash
mkdir -p .github
curl -fsSL https://raw.githubusercontent.com/yoobinshin/agents/main/kubernetes/copilot.md \
